...
6. **The member-state layer is missing.** The LED is a directive; the GDPR has opening clauses. No
   claim about what "EU law requires" is complete without transposition, and none of it is here.
